...
(function(factory) {
	...
	return kv.defineLocale('th-TH', {
		required: 'จำเป็นต้องกรอกค่าในช่องนี้',
		min: 'ต้องมีค่ามากกว่าหรือเท่ากับ {0}',
		max: 'ต้องมีค่าน้อยกว่าหรือเท่ากับ {0}',
		minLength: 'ต้องมีความยาวไม่น้อยกว่า {0} ตัวอักษร',
		maxLength: 'ต้องมีความยาวไม่เกิน {0} ตัวอักษร',
